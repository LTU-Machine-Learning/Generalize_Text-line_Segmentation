...
def Main_function(args, gt_path, out_boxes_dir):
    seed = args.seed
    ...
    for path in tqdm(image_paths):
        ...
        if args.save_boxes: 
            os.makedirs(f"{args.save_boxes_dir}/{out_boxes_dir}", exist_ok=True)
            with open(f"{args.save_boxes_dir}/{out_boxes_dir}/{img_id}.txt", "w") as f:
...
if __name__ == '__main__':
    ...
    Segmenter_trained_datasets = {
        # "READ_2016": {
        #     "seg_model_tag": "H091",
        #     "nms": (0.7, 0.7) #score_thresh, nms_thresh0
        #     },
        # "READ_2016": {
        #     "seg_model_tag": "H060",
        #     "nms": (0.55, 0.5)
    ...
    inference_datasets = {
        "READ_2016": {
            ...
            "img_ext": "JPG",
            "seg_model": ["96-10_shot_2026-05-17_ID_16533430", "96-50_shot_2026-05-17_ID_16533431"],
            },
        "Bentham": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "jpg",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519128", "96-50_shot_2026-05-13_ID_16519132"],
            },       
        "NorHandV3_331861": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "jpg",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519130", "96-50_shot_2026-05-13_ID_16519131"],
            },        
        "NorHandV3_72702": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "jpg",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519134", "96-50_shot_2026-05-13_ID_16519135"],
            },         
        "Nuremberg_Letterbooks_Band3": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "jpg",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519136", "96-50_shot_2026-05-13_ID_16519137"],
            },              
        "Riksarkivet_Bergskollegium": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "png",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519140", "96-50_shot_2026-05-13_ID_16519141"],
            },     
        "Riksarkivet_Bergskollegium2": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "png",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519142", "96-50_shot_2026-05-13_ID_16519143"],
            },     
        "Riksarkivet_Goteborgs1": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "png",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519152","96-50_shot_2026-05-13_ID_16519153"],
            },
        "Riksarkivet_Goteborgs2": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "png",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519154", "96-50_shot_2026-05-13_ID_16519161"],
            },        
        "Mix_ReNoNu": {
            ...
            "htr_bb_sorting": "IoU-matching",
            "img_ext": "jpg",
            "seg_model": ["96-10_shot_2026-05-13_ID_16519156", "96-50_shot_2026-05-13_ID_16519157"],
            }
    }
    ...
    args.results_log = f"{pathlog}/stage2_results_fewshot_newCER.txt"
    ...
    for dataset_seg, value_seg in Segmenter_trained_datasets.items():
        ...
        for dataset_inf, value_inf in inference_datasets.items():
            ...
            args.save_boxes_dir = f"{pathlog}/{value_seg['seg_model_tag']}/{value_inf['dataset_sufix']}/boxes"
            args.text = f"TrainOn_{dataset_seg}-TestOn_{dataset_inf}"
            
            gt_path = os.path.join(os.path.dirname(args.input), "gt_xml")
            os.makedirs(args.output, exist_ok=True)

            for i, seg_model in enumerate(value_inf["seg_model"]):
                out_boxes_dir = f"few-shot-{(i+1)*10}"
                args.checkpoint = f"{root}/logs/Hi-SAM_Doc/{seg_model}/saved_model/READ_2016_best_mAP.pth"
                fewshot = int(seg_model.split('-')[1].split('_')[0])

                res_mAP, f1_score, cer = Main_function(args, gt_path, out_boxes_dir)
                ...
                with open(args.results_log, "a") as f:
                    f.write(f"{value_seg['seg_model_tag']};{fewshot};{score_thresh};{nms_thresh0};{res_mAP};{f1_score};{cer};{modelname};{args.text}\n")
