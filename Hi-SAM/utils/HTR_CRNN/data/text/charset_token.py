from utils.HTR_CRNN.data.globalvalue.text_comon_values import BLANK_STR_TOKEN, SOS_STR_TOKEN, EOS_STR_TOKEN
...
class CharsetToken(object):
    ...
    def __init__(self, list_charset_file,  use_blank=False, use_sos=False, use_eos=False):
