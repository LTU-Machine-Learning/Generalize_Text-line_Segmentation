...
from hi_sam.data.dataloader import get_im_gt_name_dict, create_dataloaders, eval_transforms, eval_transform2, custom_collate_fn, ColorJitter, RandomRotate, LargeScaleJitter, ToTensor
...
def get_args_parser():
    ...
    parser.add_argument('--aug_rotate', default=20, type=int)
...
def main(train_datasets_lst, valid_datasets_lst, args):
    ...
    train_transforms = [
        ColorJitter(), 
        RandomRotate(angle=args.aug_rotate),
        LargeScaleJitter(),
        ToTensor()
    ]
...
if __name__ == "__main__":
    ...
    read2016_train = {
        ...
        "gt_dir": f"{args.data_root}/READ_2016/Training/labels",
        "im_ext": ".JPG",
        "gt_ext": ".png",
    }
    totaltext_train = {
    ...
    read2016_val = {
        ...
        "gt_dir": f"{args.data_root}/READ_2016/Validation/labels",
        "im_ext": ".JPG",
        "gt_ext": ".png",
    }
    read2016_test = {
        ...
        "gt_dir": f"{args.data_root}/READ_2016/Test/labels",
        "im_ext": ".JPG",
        "gt_ext": ".png",
    }
    totaltext_test = {
