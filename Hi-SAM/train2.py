...
def main(train_datasets_lst, valid_datasets_lst, args):
    ...
    if not args.eval:
        ...
        train(args, model, optimizer, train_dataloaders, train_datasets_names, valid_dataloaders, valid_datasets_names, valid_datasets_lst)
    else:
...
def train(args, model, optimizer, train_dataloaders, train_datasets_names, valid_dataloaders, valid_datasets_names, valid_datasets):
    ...
    for epoch in range(epoch_start, epoch_num):
        # validation_total_loss = validation(args, model, valid_dataloaders, epoch)
        # print("######################################")
