...
def get_args_parser():
    ...
    parser.add_argument("--fewshot_dir", type=str, default="fewshot5")
...
def train(args, model, optimizer, train_dataloaders, train_datasets_names, valid_dataloaders, valid_datasets_names, valid_datasets, valid_dataloaders2):
    ...
    for epoch in range(epoch_start, epoch_num):
        ...
        if (epoch >= args.lr_drop_epoch) and (LR_drop == False):
...
if __name__ == "__main__":
    ...
    read2016_train = {
        "name": "READ_2016",
        "im_dir": f"{args.data_root}/{args.fewshot_dir}/train/Images",
        "gt_dir": f"{args.data_root}/{args.fewshot_dir}/train/bin_masks_otsu_hi-sam",
