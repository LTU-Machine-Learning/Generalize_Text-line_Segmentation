...
if __name__ == '__main__':
    ...
    # export_hisam_for_inference(
    # model=hisam,                       # or your trained `model`
    # out_path=os.path.join(args.output, "hisam_segmentation.pth"),
    ...
    if args.map :
        ...
        with open(args.results_log, "a") as f:
            f.write(f"{args.exp_id};{score_thresh};{nms_thresh0};{res_mAP};{f1_score};{modelname};{args.text}\n")
