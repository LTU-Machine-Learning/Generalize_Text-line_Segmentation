    ...
    if checkpoint is not None:
        ...
        if args.hier_det:
            ...
            if not contain_hi_decoder:
                ...
                with open(os.path.join(args.pretrained_path, args.model_type+'_maskdecoder.pth'), "rb") as f:
        ...
        if args.model_type == 'vit_b':
            sam_path = os.path.join(args.pretrained_path, 'sam_vit_b_01ec64.pth')
        elif args.model_type == 'vit_l':
            sam_path = os.path.join(args.pretrained_path, 'sam_vit_l_0b3195.pth')
        elif args.model_type == 'vit_h':
            sam_path = os.path.join(args.pretrained_path, 'sam_vit_h_4b8939.pth')
        ...
        if args.hier_det:
            ...
            for key in state_dict.keys():
                if 'hi_decoder' in key:
                    ...
                    break
            if not contain_hi_decoder:
                with open(os.path.join(args.pretrained_path, args.model_type+'_maskdecoder.pth'), "rb") as f_maskdecoder:
