...
# The job
PRETRAINE_MODEL="${root}/logs/Hi-SAM_Doc/79_2025-12-09_ID_14909194/saved_model/READ_2016_best_mAP.pth"
...
python "$main_script" \
  ...
  --output "${root}/logs/Hi-SAM_Doc/Stage_3/H079/NorHandv3_mini_v3/train/images" \
  --save_boxes True \
  --save_boxes_dir "${root}/logs/Hi-SAM_Doc/Stage_3/H079/NorHandv3_mini_v3/train/boxes" \
  --dataset ctw1500 \
  --exp_id 79 \
  --nms 0.6 0.6 \
>> "$output_file"
...
python "$main_script" \
  ...
  --output "${root}/logs/Hi-SAM_Doc/Stage_3/H079/NorHandv3_mini_v3/val/images" \
  --save_boxes True \
  --save_boxes_dir "${root}/logs/Hi-SAM_Doc/Stage_3/H079/NorHandv3_mini_v3/val/boxes" \
  --dataset ctw1500 \
  --exp_id 79 \
  --nms 0.6 0.6 \
>> "$output_file"