...
PRETRAINE_MODEL="${root}/logs/Hi-SAM_Doc/86_2026-01-25_ID_15294758/saved_model/READ_2016_intermediate.pth"
...
torchrun --nproc_per_node=6 "$main_script" \
  ...
  --hier_det \
  --skip_words 1 \
  --data_root /home/x_gapat/PROJECTS/DATASETS/NorHandv3_mini_v3 \
