...
PRETRAINE_MODEL="/home/gayapath/PROJECTS/logs/Hi-SAM_Doc/47_2025-09-16_ID_/saved_model/READ_2016_best_mAP.pth"

export PYTHONPATH=/home/gayapath/PROJECTS/codes/Hi-SAM_Doc/

# The job
CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --nproc_per_node=4 --master-port=29501 "$main_script" \
  ...
  --hier_det \
  --skip_words 1 \
  --data_root /home/gayapath/PROJECTS/DATA_DGX0/ \
