...
SPLIT=val
DATA_IN_READ2016="${data_root}/READ_2016/${SPLIT}/Images"
DATA_IN_IAM="${data_root}/IAM/pages_cleaned/${SPLIT}/images"
DATA_IN_Norhandv3="${data_root}/NorHandv3/${SPLIT}/images"
...
#   --results_log "$output_file" \
# >> "$output_file2"
# echo "../../logs/Hi-SAM_Doc/sample_output/H077/IAM/${SPLIT}/boxes" 
# CUDA_VISIBLE_DEVICES=2 python "$main_script" \
#   --checkpoint "${CHECKPOINT}/READ_2016_best_mAP.pth" \
#   --model-type vit_h \
#   --pretrained_path "$PRETRAINE_PATH" \
...
#   --results_log "$output_file" \
#   --save_boxes True \
#   --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H077/IAM/${SPLIT}/boxes" \
# >> "$output_file2"

echo "../../logs/Hi-SAM_Doc/sample_output/H077/NorHandV3/${SPLIT}/boxes" 
CUDA_VISIBLE_DEVICES=4 python "$main_script" \
  --checkpoint "${CHECKPOINT}/READ_2016_best_mAP.pth" \
  --model-type vit_h \
  --pretrained_path "$PRETRAINE_PATH" \
  --input "$DATA_IN_Norhandv3" \
  --output "../../logs/Hi-SAM_Doc/sample_output/H077/NorHandV3/${SPLIT}/images" \
  --dataset ctw1500 \
  --nms 0.6 0.6 \
  --text Norhandv3 \
  --results_log "$output_file" \
  --save_boxes True \
  --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H077/NorHandV3/${SPLIT}/boxes" \
>> "$output_file2"
...
#   --results_log "$output_file" \
#   --save_boxes True \
#   --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H078/IAM/${SPLIT}/boxes" \
# >> "$output_file2"
...
#   --results_log "$output_file" \
#   --save_boxes True \
#   --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H078/NorHandV3/${SPLIT}/boxes" \
# >> "$output_file2"
...
#   --results_log "$output_file" \
#   --save_boxes True \
#   --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H079/IAM/${SPLIT}/boxes" \
# >> "$output_file2"
...
#   --results_log "$output_file" \
#   --save_boxes True \
#   --save_boxes_dir "../../logs/Hi-SAM_Doc/sample_output/H079/NorHandV3/${SPLIT}/boxes" \
# >> "$output_file2"
