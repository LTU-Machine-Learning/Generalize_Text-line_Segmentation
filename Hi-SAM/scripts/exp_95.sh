...
PRETRAINE_MODEL="/home/x_gapat/PROJECTS/logs/Hi-SAM_Doc/95_2026-04-15_ID_16303272/saved_model/READ_2016_intermediate.pth"
...
torchrun --nproc_per_node=6 "$main_script" \
  ...
  --hier_det \
  --skip_words 1 \
  --data_root /home/x_gapat/PROJECTS/DATASETS/Nuremberg_Letterbooks/Band3 \
