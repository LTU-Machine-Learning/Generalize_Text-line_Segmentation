...
PATHLOG="${root}/logs/ATS/Hi-SAM/stage3"
echo "path log :"
echo ${PATHLOG}

output_file="${PATHLOG}/out.txt"

export CUDA_VISIBLE_DEVICES=0 pythonPATH=/proj/document_analysis/users/x_gapat/codes/Hi-SAM_Doc/
...
#   --save_boxes_dir "${PATHLOG}/H091/READ_2016/boxes/val" \
#   --save_boxes True \
#   --dataset ctw1500 \
#   --exp_id 0 \
#   --nms 0.7 0.7 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --model-type vit_h \
  --pretrained_path "${root}/logs/Hi-SAM_Doc/pretrained_checkpoint" \
  --input "${root}/DATASETS/IAM/pages_cleaned/val/Images" \
  --output "${PATHLOG}/H091/IAM/images" \
  --save_boxes_dir "${PATHLOG}/H091/IAM/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.7 0.7 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --save_boxes_dir "${PATHLOG}/H091/NorHandv3_mini_v3/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.7 0.7 \
...
#   --save_boxes_dir "${PATHLOG}/H092/READ_2016/boxes/val" \
#   --save_boxes True \
#   --dataset ctw1500 \
#   --exp_id 0 \
#   --nms 0.45 0.3 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --save_boxes_dir "${PATHLOG}/H092/IAM/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.45 0.3 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --save_boxes_dir "${PATHLOG}/H092/NorHandv3_mini_v3/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.45 0.3 \
...
#   --save_boxes_dir "${PATHLOG}/H093/READ_2016/boxes/val" \
#   --save_boxes True \
#   --dataset ctw1500 \
#   --exp_id 0 \
#   --nms 0.35 0.6 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --save_boxes_dir "${PATHLOG}/H093/IAM/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.35 0.6 \
...
CUDA_VISIBLE_DEVICES=0 python "$main_script" \
  ...
  --save_boxes_dir "${PATHLOG}/H093/NorHandv3_mini_v3/boxes/val" \
  --save_boxes True \
  --dataset ctw1500 \
  --exp_id 0 \
  --nms 0.35 0.6 \
