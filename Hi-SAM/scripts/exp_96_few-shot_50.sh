...
PRETRAINE_MODEL="/home/x_gapat/PROJECTS/logs/Hi-SAM_Doc/96_2026-04-15_ID_16302713/saved_model/READ_2016_best_mAP.pth"

export PYTHONPATH=/proj/document_analysis/users/x_gapat/codes/Hi-SAM_Doc/

# The job
torchrun --nproc_per_node=1 --master-port=29528 "$main_script" \
  ...
  --hier_det \
  --skip_words 1 \
  --data_root /home/x_gapat/PROJECTS/DATASETS/READ_2016 \
