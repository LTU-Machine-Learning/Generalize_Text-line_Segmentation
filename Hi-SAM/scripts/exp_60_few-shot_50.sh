...
# PRETRAINE_MODEL="/home/x_gapat/PROJECTS/logs/Hi-SAM_Doc/60-50_shot_2026-05-01_ID_16472770/saved_model/final_epoch_200.pth"
...
# The job
torchrun --nproc_per_node=1 --master-port=29511 "$main_script" \
  ...
  --hier_det \
  --skip_words 1 \
  --data_root /home/x_gapat/PROJECTS/DATASETS/Riksarkivet_Bergskollegium2 \
  --fewshot_dir fewshot50 \
